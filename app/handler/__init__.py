...
class RedisSession(BaseSession):
    ...
    def open_session(self, request: HTTPServerRequest) -> BaseSession:
        ...
        self.sid, self.user_info = session_id, user_info
        return self

    def save_session(self, request: HTTPServerRequest, user_info: dict) -> BaseSession:
